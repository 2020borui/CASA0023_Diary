...
![remote sensing process Source: Remote Sensing for Dummies](img/remote.jpg){#fig1 width="300px" fig-align="center"}
...
![Model accuracy for different data sources Source: Ram C. Sharma's article](img/acc.png){width="300px" fig-align="center"}
