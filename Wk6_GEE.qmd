...
```{r, echo=FALSE, fig.align='center', out.width="300px", out.height="300px",fig.cap="Github limitation(chatgpt generated)"}
...
read_excel(here("tables", "table6.xlsx")) %>%
  knitr::kable(booktabs = TRUE,format = "html", caption = 'The differences between GEE and R') %>%
